...
int AcquireImages(CameraPtr pCam, INodeMap& nodeMap, INodeMap& nodeMapTLDevice)
{
    ...
    try
    {
        ...
        for (unsigned int imageCnt = 0; true; imageCnt++)
        {
            try
            {
                //
                ...
                else
                {
                    ...
                    uint64_t timestamp=convertedImage->GetTimeStamp();
                    
                    cout<<"Image Timestamp "<<timestamp<<endl<<endl;

                    cout <<"Duration since start acquiring in second: "<<(float)(getReadableTimestamp(timestamp)/1000.0)<< endl;
...
int RunSingleCamera(CameraPtr pCam)
{
    ...
    try
    {
        ...
        cout<<"Image width value from Camera Setting: "<<width->GetValue()<<endl;
        cout<<"Image height value from Camera Setting: "<<height->GetValue()<<endl;
