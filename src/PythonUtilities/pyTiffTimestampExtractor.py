...
def extract_all_timestamp_from_folder(folder_path, file_name_structure, first_trial_index = 1, verbose = False):
  """
    This function takes in a path to folder containing the tiff file and returns a dictionary contains timestamp of all the image in the folder
    ...
    @param file_name_structure: The file name structure of image file inside the folder
      ...
      a pair of {}
      With the above structure, the descritor will be
      ...
      so the folder list looks like
        ...
        If user wants to extract the remaining 3 files from 19144903 camera, he/she has to call this function another time like
